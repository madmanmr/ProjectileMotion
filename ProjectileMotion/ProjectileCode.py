...
async def main():
    global screen, clock
    global running, VarChoice, Shoot, End, GameOver, cheats, shots, hit_registered, points, pointsold, cheatbcol
    global t, xpres, ypres, distancepres, heightpres, thetapres, speed, thetao, Vo, g, Ellx
    global prevMouseClick, mousePos, mousePress
